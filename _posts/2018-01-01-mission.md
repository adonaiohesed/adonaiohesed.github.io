...
<br><br>
Most recently I worked at CableLabs and developed a detection system for BGP hijacking attacks. Because BGP essentially assumes all networks are trustworthy, there is vulnerable to use legitimate network prefix. Unfortunately, BGP hijacking can be difficult to detect as the owner of the network prefix is unable to detect the hijack themselves. So my solution helps to detect it for our clients by monitoring the whole network and it is anomaly-based IDS. Thanks to this solution, clients can detect the hijacking and prevent DDoS attacks or loss of their traffic.
<br><br>
