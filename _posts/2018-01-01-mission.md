...
<br><br>
My background is cyber security as a master degree and computer science as a bachelor. Most recently I worked at CableLabs and developed a detection system for BGP hijacking attacks. Because BGP essentially assumes all networks are trustworthy, there is vulnerable. No security safeguards have yet been incorporated globally that can validate routes are authentic, it has vulnerability to be attacked by using legitimate network prefix. Unfortunately, BGP hijacking can be difficult to detect as the owner of the network prefix is unable to detect the hijack themselves. So my solution helps to detect it to our clients by monitoring the whole network. The solution is anomaly-based IDS. Thanks to this solution, the clients can detect the hijacking by my monitoring system and prevent DDoS attacks or loss of their traffic.
<br><br>
Before that, I worked for Cisco on an open-source project that educates general software engineers about Cryptography. Not all engineers can use proper cryptography yet. The goal of this project was to properly train such engineers. I provide documentation of cryptography to technical stakeholders such as what vulnerability of MD5 is, what is TLS and how to implement it.
<br><br>
