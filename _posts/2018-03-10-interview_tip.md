...
1. 커뮤니케이션이 가장 중요하다. 천천히 말하고 반복되는 Actually와 같은 쓸데 없는 말은 최대한 자제하라.
...
1. 마지막으로 오퍼 사인전까지 아무 생각말고 끊임없이 여러개의 회사에 지원을해라. 하나에 목매달리 시작하면 그 하나에 너무 간절한 나머지 제대로 인터뷰 및 협상이 되지 않을 수 있다.
1. 인터뷰를 할 때 잘 듣고 대화가 잘 통하는 사람이 기억에 남는다.
1. 거만한 사람은 모두가 싫어한다. 자신만의 방법을 고집하는 사람도 좋아할 사람이 별로 없을 것이다.
1. 줌 미팅으로 인터뷰를 볼 때는 이야기 할 때 상대방의 화면 혹은 나의 화면을 보면서 해라. 다른 곳을 보는 것은 자신감이 없어 보일 수 있다.
...
1. 기업입장에서는 인터뷰는 못했지만 실제 일 잘하는 사람을 탈락시키는 것은 acceptable하다. 인터뷰는 잘하지만 일을 못하는 사람을 뽑는것에 대한 경각심은 크기 않다. 인터뷰를 잘하는것이 중요하다.
